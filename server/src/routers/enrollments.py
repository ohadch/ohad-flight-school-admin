...
from src.schemas.enrollment import EnrollmentSchema, EnrollmentCreateSchema, EnrollmentUpdateSchema
...
async def create_enrollment(enrollment_schema: EnrollmentCreateSchema, db: Session = Depends(get_db)):
...
async def update_enrollment(enrollment_id: int, enrollment_schema: EnrollmentUpdateSchema, db: Session = Depends(get_db)):
